...
import { Search, MapPinned, Navigation, MapPinOff, Plus } from "lucide-react";
    ...
    <div className="flex flex-col">
      <header className="bg-gradient-to-br from-emerald-600 to-teal-700 px-4 pb-4 pt-6 text-white">
        <div className="flex items-start justify-between gap-2">
          ...
          <Link
            href="/add"
            className="inline-flex shrink-0 items-center gap-1 rounded-full bg-white/15 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur transition hover:bg-white/25"
          >
            <Plus size={14} /> Tambah
          </Link>
        </div>
